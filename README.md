...
**Credits:** This project is based on the work of [roman-la](https://github.com/roman-la). You can find the original project here: [kickbase-analysis](https://github.com/roman-la/kickbase-analysis/tree/main).
...
If you want to get an idea of how the visualization looks, check out [https://torbenstriegel.github.io/Kickbase-Analysis-Tool/](https://torbenstriegel.github.io/Kickbase-Analysis-Tool/).
